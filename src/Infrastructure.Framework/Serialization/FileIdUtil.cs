...
namespace Giacomelli.Unity.Metadata.Infrastructure.Framework.Serialization
{
	...
	public static class FileIdUtil
	{
		...
		{
			if (type.Assembly.GetName().Name.Equals("Assembly-CSharp"))
			{
				return 11500000;
			}

			return FromType(type.Namespace + type.Name);
		}
		...
		/// <returns>The type.</returns>
		/// <param name="type">Type.</param>
		public static int FromType(string typeName)
		{
			...
			string toBeHashed = "s\0\0\0" + typeName;
