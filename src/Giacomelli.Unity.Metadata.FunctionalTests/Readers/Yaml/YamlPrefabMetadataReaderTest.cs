...
namespace Readers.Yaml
{
	...
	public class YamlPrefabMetadataReaderTest
	{
		...
		{
			MetadataConfig.Initialize("Readers/Yaml/Resources/");
		}
		...
		public void Read_PrefabSample1_Metadata ()
		{
			...
			var yaml = File.OpenText ("Readers/Yaml/Resources/PrefabSample1.prefab");
		...
		{
			var target = new YamlPrefabMetadataReader();
			var yaml = File.OpenText("Readers/Yaml/Resources/PrefabSample2.prefab");
			var actual = target.Read(yaml);
